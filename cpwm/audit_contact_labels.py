            ...
            writer.writerow(
                {
                    ...
                    "contact_left_hand": labels["contact_left_hand"],
                    "contact_right_hand": labels["contact_right_hand"],
                    "contact_foot": labels["contact_foot"],
                    "contact_left_foot": labels["contact_left_foot"],
                    "contact_right_foot": labels["contact_right_foot"],
                    "contact_torso": labels["contact_torso"],
                    "contact_object": labels["contact_object"],
                    "contact_robot_object": labels["contact_robot_object"],
                    "contact_hand_object": labels["contact_hand_object"],
                    "contact_foot_floor": labels["contact_foot_floor"],
                    "contact_robot_floor": labels["contact_robot_floor"],
                    "contact_object_table": labels["contact_object_table"],
                    "reviewed": 0,
                    "notes": "",
                }
            )
