...
PPO_TRAIN_STEPS=${PPO_TRAIN_STEPS:-5000}
EVAL_STEPS=${EVAL_STEPS:-1000}
PPO_EVAL_EPISODES=${PPO_EVAL_EPISODES:-3}
NUM_ENVS=${NUM_ENVS:-1}
...
echo "Target budget: about 30 minutes or less on a single GPU, shorter in DRY_RUN=1"
